...
def find_contacts(file, peptide, receptor):
    ...
    output_file = open(f'/proj/wallner/users/x_karst/exjobb/evaluate_scoring_matrix/propro_matrix/proteinpeptide_scored/c_script_output/{first_name}/{last_name}.output', "w")
...
def calc_score(file, likelihood_score_dict, cut_off, peptide, receptor):
    ...
    output_read = open(f"/proj/wallner/users/x_karst/exjobb/evaluate_scoring_matrix/propro_matrix/proteinpeptide_scored/c_script_output/{first_name}/{last_name}.output", "r")
    ...
    os.remove(f"/proj/wallner/users/x_karst/exjobb/evaluate_scoring_matrix/propro_matrix/proteinpeptide_scored/c_script_output/{first_name}/{last_name}.output")
...
def main():
    try:
        ...
        print("USAGE: <file.csv> cutoff target")
        return


    matrix_file = "/proj/wallner/users/x_karst/exjobb/protein_peptide_data/gijv_propro_isolated.csv"
    likelihood_score_dict = read_csv(matrix_file)
    list_of_files = make_list_of_files(target_directory)

    result_file = open(f"/proj/wallner/users/x_karst/exjobb/evaluate_scoring_matrix/propro_matrix/proteinpeptide_scored/propromatrix_propep_{target_directory}.txt", "w")
