...
def find_contacts(file, peptide, receptor):
    ...
    output_file = open(f'/proj/wallner/users/x_karst/exjobb/evaluate_scoring_matrix/glaser_matrix/propep/c_script_output/{first_name}/{last_name}.output', "w")
...
def calc_score(file, likelihood_score_dict, cut_off, peptide, receptor):
    ...
    output_read = open(f"/proj/wallner/users/x_karst/exjobb/evaluate_scoring_matrix/glaser_matrix/propep/c_script_output/{first_name}/{last_name}.output", "r")
    ...
    os.remove(f"/proj/wallner/users/x_karst/exjobb/evaluate_scoring_matrix/glaser_matrix/propep/c_script_output/{first_name}/{last_name}.output")
...
def main():
    ...
    matrix_file = "/proj/wallner/users/x_karst/exjobb/tables/gij_v_glaser_table.csv"
    likelihood_score_dict = read_csv(matrix_file)
    list_of_files = make_list_of_files(target_directory)

    result_file = open(f"/proj/wallner/users/x_karst/exjobb/evaluate_scoring_matrix/glaser_matrix/propep/glaserscore_propep_{target_directory}.txt", "w")
