...
def find_all_contacts(complex, pro_interface_dict, composition_counter, check, one_model, within_model, between_models, cut_off, no_interchain_contacts_file):
    translation_dict = {}
...
def plot_number_of_interactions(pro_interface_dict, check, is_pep):
    if is_pep == True:
        fig_path = "/proj/wallner/users/x_karst/exjobb/pictures/numb_interactions_propep.png"
    else:
        fig_path = "/proj/wallner/users/x_karst/exjobb/pictures/numb_interactions_propro.png"
...
def plot_normalized_contacts_and_likelihood(pro_interface_dict, check, fraction_dict, is_pep):
    ...
    import matplotlib.pyplot as plt
    if is_pep:
        plt.savefig("/proj/wallner/users/x_karst/exjobb/pictures/pro_pep_normalized_interactions.png", bbox_inches='tight')
    else:
        plt.savefig("/proj/wallner/users/x_karst/exjobb/pictures/pro_pro_normalized_interactions.png", bbox_inches='tight')
    plt.show()
...
#    df_2 = df_2.sort_index(1)
    ...
    import matplotlib.pyplot as plt
    if is_pep:
        plt.savefig("/proj/wallner/users/x_karst/exjobb/pictures/gij_propep_sym.png", bbox_inches='tight')
    else:
        plt.savefig("/proj/wallner/users/x_karst/exjobb/pictures/gij_propro_isolated.png", bbox_inches='tight')
    plt.show()
    ...
    if is_pep == True:
        df_3_reorder.to_csv('/proj/wallner/users/x_karst/exjobb/protein_peptide_data/gijv_propep_sym.csv', index = False)
    else:
        df_3_reorder.to_csv('/proj/wallner/users/x_karst/exjobb/protein_peptide_data/gijv_propro_isolated.csv', index = False)
    ...
    import matplotlib.pyplot as plt
    if is_pep:
        plt.savefig("/proj/wallner/users/x_karst/exjobb/pictures/gijv_propep_sym.png", bbox_inches='tight')
    else:
        plt.savefig("/proj/wallner/users/x_karst/exjobb/pictures/gijv_propro_isolated.png", bbox_inches='tight')
    plt.show()
...
def main():
    ...
    try:
        ...
        print("USAGE: run_C_script.py cutoff [-propep] [-propro]")
    ...
    if is_pep == "-propep":
        ...
        is_pep = False
        dataset_file = "/proj/wallner/users/x_karst/exjobb/protein_peptide_data/protein_protein_dataset.out"
    ...
    if is_pep:
        wrongs_file = open("/proj/wallner/users/x_karst/exjobb/protein_peptide_data/cscript_errors_propepsym.txt", "w")
        no_interchain_contacts_file = open("/proj/wallner/users/x_karst/exjobb/protein_peptide_data/cscript_no_interchain_contacts_propepsym.txt", "w")

    else:
        wrongs_file = open("/proj/wallner/users/x_karst/exjobb/protein_peptide_data/cscript_errors_proproiso.txt", "w")
        no_interchain_contacts_file = open("/proj/wallner/users/x_karst/exjobb/protein_peptide_data/cscript_no_interchain_contacts_proproiso.txt", "w")
    ...
    for complex in complexes:
        try:
            check, one_model, within_model, between_models = find_all_contacts(complex, pro_interface_dict, composition_counter, check, one_model, within_model, between_models, cut_off, no_interchain_contacts_file)
        except KeyError:
    ...
    plot_number_of_interactions(pro_interface_dict, check, is_pep)
    fraction_dict = calc_composition(composition_counter, check)
    plot_normalized_contacts_and_likelihood(pro_interface_dict, check, fraction_dict, is_pep)
