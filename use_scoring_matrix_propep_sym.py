...
def main():
    ...
    matrix_file = "/proj/wallner/users/x_karst/exjobb/protein_peptide_data/gij_v_results_pro_pep.csv"
    likelihood_score_dict = read_csv(matrix_file)
    list_of_files = make_list_of_files(target_directory)

    result_file = open(f"/proj/wallner/users/x_karst/exjobb/evaluate_scoring_matrix/pro_pep/myscores_sym/myscore_propep_{target_directory}.txt", "w")
